...
if is_ppc64le; then
  ...
  curl -L -o bosh-agent "https://s3.amazonaws.com/ng-bosh-softlayer-agent/bosh-agent-2.117.0-ng.11-linux-amd64"
  # echo "665a179ecf701e0d78a34218d43fe075983ce812a4a237a42f96244358e1df9b  bosh-agent" | shasum -a 256 -c -
fi
